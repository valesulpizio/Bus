...
public class Buses_trial : Trial
{
    ...
    private static readonly string[] trialListHeader = { "Break","SM_velocity", "OM_velocity", "onset", "duration", "ITI_duration"};
    override public string[] TrialListHeader => trialListHeader;

    // Define the header of the results file here
    private static readonly string[] resultsFileHeader = { "tBreak", "SM_velocity", "OM_velocity", "onset", "duration", "ITI_duration", "StartTime", "ChangeTime" };
    ...
    {Break = int.Parse(values[0]);
        ...
        ITI_duration = float.Parse(values[5]);
    }
    ...
    override protected object[] Save()
    {
        ...
        return new object[] { "Break", "SM_velocity", "OM_velocity", "onset", "duration", "ITI_duration", StartTime, ChangeTime };
    }
}